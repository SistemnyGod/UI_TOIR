...
[ApiController]
[Route("api/v3/results")]
public sealed class ResultsV3Controller(IPatrolResultQuery resultQuery) : ControllerBase
{
    [HttpGet]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Ok(await resultQuery.GetResultGroupsPageAsync(filter, page, pageSize, cancellationToken));
    }
}
