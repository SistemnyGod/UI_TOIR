...
public sealed record EmuShiftReportEmployeeOptionDto(Guid Id, string FullName, string PersonnelNo, string Position, string Department, string WorkerCategory);
...
public sealed record EmuShiftReportQueryDto(DateOnly? Date = null, DateOnly? DateFrom = null, DateOnly? DateTo = null, string? ShiftType = null, string? WorkerCategory = null, Guid? EmployeeId = null, string? Search = null, int Page = 1, int PageSize = 50);
