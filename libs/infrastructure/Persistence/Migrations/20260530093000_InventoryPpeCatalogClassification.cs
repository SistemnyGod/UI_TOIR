...
[Migration("20260530093000_InventoryPpeCatalogClassification")]
public partial class InventoryPpeCatalogClassification : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql("""
            ...
            WHERE item.category_id = category.id
              ...
              AND (
                  item.item_kind IS NULL
                  OR btrim(item.item_kind) = ''
                  OR lower(item.item_kind) NOT IN ('ppe', 'siz')
              );
