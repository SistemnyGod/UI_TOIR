...
[Migration("20260602120000_PercoIntegrationStage1")]
public partial class PercoIntegrationStage1 : Migration
{
    ...
    {
        migrationBuilder.Sql("""
            DROP TABLE IF EXISTS employee_presence_intervals;
            DROP TABLE IF EXISTS perco_access_events;
            DROP TABLE IF EXISTS perco_employee_links;
            DROP TABLE IF EXISTS perco_sync_state;
            DROP TABLE IF EXISTS perco_integration_logs;
            DROP TABLE IF EXISTS perco_integration_settings;
            """);
    }
}
