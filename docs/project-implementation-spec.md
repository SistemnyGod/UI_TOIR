...
> **Статус документа: исходная целевая спецификация, а не отчет о готовности.**
> Формулировки «будет», mock-сценарии и этапы ниже сохраняются для трассировки требований.
> Фактический статус реализации приведен в [modules.md](./modules.md), а текущая архитектура — в [architecture.md](./architecture.md).
